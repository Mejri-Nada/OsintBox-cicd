...
const Platform = () => {
  return (
    <section className="md:pt-44 sm:pt-24 pt-12 relative z-1" style={{paddingBottom:"10em", paddingTop:"10em", background: "transparent"}}>
        ...
        <div className="bg-section bg-opacity-10 px-16 py-14 rounded-3xl border-2 border-opacity-20 border-section grid grid-cols-12 items-center before:content-[''] before:absolute relative before:w-96 before:h-64 before:bg-start before:bg-no-repeat before:-bottom-11 overflow-hidden lg:before:right-48 before:-z-1 before:opacity-10 ">
          <div className="lg:col-span-8 col-span-12">
            <h2 className="text-white sm:text-40 text-30 mb-6">
              Powered by Your <span className="text-primary">Cyber</span> Intelligence Platform
            </h2>
            <p className="text-muted text-opacity-60 text-18">
              Our advanced tools empower you to gain unparalleled insights and
              <br /> enhance your digital security posture with confidence.
            </p>
          </div>
          <div className="lg:col-span-4 col-span-12">
            <div className="flex lg:justify-end lg:mt-0 mt-7 justify-center">
              <Link
                href="/tech-scan" // Changed href to a relevant scan page
                className="text-darkmode bg-primary border border-primary py-3 px-5 rounded-lg sm:text-21 text-18 font-medium hover:bg-transparent hover:text-primary transition duration-200 ease-in-out"
              >
                Start Your Scan
              </Link>
            </div>
